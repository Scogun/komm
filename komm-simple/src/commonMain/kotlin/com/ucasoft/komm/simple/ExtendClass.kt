...
@KOMMMap(from = SourceObject::class, config = MapConfiguration(allowNotNullAssertion = true, tryAutoCast = true, mapDefaultAsFallback = false))
...
@KOMMMap(from = SourceObject::class, config = MapConfiguration(allowNotNullAssertion = false, tryAutoCast = true, mapDefaultAsFallback = false))
